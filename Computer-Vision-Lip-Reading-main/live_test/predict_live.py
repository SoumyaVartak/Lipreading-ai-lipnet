...
model.load_weights("C:/mainpro/Computer-Vision-Lip-Reading-main/live_test/model_weights.h5")

# Load the detector
detector = dlib.get_frontal_face_detector()

# Load the predictor
predictor = dlib.shape_predictor("C:/mainpro/Computer-Vision-Lip-Reading-main/face_weights.dat")
